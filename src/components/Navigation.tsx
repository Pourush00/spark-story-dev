...
const Navigation = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-7xl transition-all duration-300 rounded-2xl ${
          isScrolled
            ? 'bg-background/95 backdrop-blur-md shadow-2xl shadow-black/20 border border-border/50'
